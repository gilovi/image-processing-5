...
%resaping the matrices so we can sample every 5th patch
...
weights = permute(weights, [1 4 2 5 3]);
...
samp_im = interp2(renderedPyramid, samplingPositionsX, samplingPositionsY ,'cubic');
